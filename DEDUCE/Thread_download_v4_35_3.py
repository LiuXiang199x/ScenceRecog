...
if __name__ == '__main__':
    #path = '/media/agent/eb0d0016-e15f-4a25-8c28-0ad31789f3cb/scene_dataset/35W'
# save_path = sys.argv[2]
    txt = '/mnt/sdc/zhuhao/scene_dataset/url/35_3(start_3).txt'
    save_path = '/mnt/sdc/zhuhao/scene_dataset/35W'
    save_path = os.path.join(save_path, '3')
