# Usage: python train_deduce_combined_v5.py -a resnet18 -b=20 -j=8 -p=100 --config config/nanodet_irbt_list_dataset.yml --model workspace/nanodet-plus-m-1.5x_416/model_best/nanodet_model_best.pth --num_classes=5
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, filename + '_latest_combined_v5.pth.tar')
    if is_best:
        shutil.copyfile(filename + '_latest_combined_v5.pth.tar', filename + '_best_combined_v5.pth.tar')
