# Usage: python train_deduce_scene_home_v5.py -a resnet18 -b=10 -j=4 -p=1000 --num_classes=6
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    torch.save(state, filename + '_latest_home_v6.pth.tar')
    if is_best:
        shutil.copyfile(filename + '_latest_home_v6.pth.tar', filename + '_best_home_v6.pth.tar')
