# python test_combined_v10.py --dataset=data --envtype=home --config config/nanodet_irbt_list_dataset.yml --model workspace/nanodet-plus-m-1.5x_416/model_best/nanodet_model_best.pth
...
txt_path = "detailed_prediction_v10.txt"
...
for class_name in os.listdir(valdir):
    ...
    for img_name in os.listdir(os.path.join(valdir,class_name)):
        ...
        # forward pass
        logit = all_model.forward(input_img, t)
...
file_txt.close()
workbook.save('detailed_prediction_logit_v10.xls')
