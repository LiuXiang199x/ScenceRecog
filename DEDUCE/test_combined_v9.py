# python test_combined_v9.py --dataset=data --envtype=home --config config/nanodet_irbt_list_dataset.yml --model workspace/nanodet-plus-m-1.5x_416/model_best/nanodet_model_best.pth
...
model_file = '%s_best_combined_v9.pth.tar' % arch
...
file_txt.close()
workbook.save('detailed_prediction_logit_v9.xls')
