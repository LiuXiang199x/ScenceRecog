...
def count_nums(f_path):
    f_name = open(f_path)
    label_dics = {}
    label_names = ['balcony', 'bed_room ', 'CrossLook_DoorFrame', 'unknown', 'others', 'blurredimag', 'CrossLook_Door', 'person_leg', 'wall', 'LargeOcclusion', 'table_foot', 'toilet_room', 'protective_fence', 'kitchen', 'drawing_room', 'dining_room', 'test_room']
