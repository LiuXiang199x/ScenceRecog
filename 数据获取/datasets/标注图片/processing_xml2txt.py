...
def creat_txts(xml_path):
    ...
    saveUrl_file = open("数据获取/datasets/标注图片/pics_name/TV/TV.txt", "w")
    saveName_file = open("数据获取/datasets/标注图片/pics_url/TV/TV.txt", "w")
    i = 0
...
toilet_xml_path = "数据获取/datasets/标注图片/pic_annotation/TV/场景分类_TV（已标注）"
